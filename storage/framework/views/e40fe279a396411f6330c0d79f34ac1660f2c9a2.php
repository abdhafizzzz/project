                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            ...
                            ?>
                            <?php if($check->musim || $check->musim2): ?>
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                            ...
                            <ul class="nav nav-treeview">
                                <?php if($check->musim): ?>
                                    <li class="nav-item">
                                        <a href="<?php echo e(route('ptundaf')); ?>" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Luar Musim</p>
                                        </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(route('carian')); ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Carian Tuntutan</p>
                                    </a>
                                </li>
...
<?php /**PATH C:\laragon\www\project-master\resources\views/navigation.blade.php ENDPATH**/ ?>