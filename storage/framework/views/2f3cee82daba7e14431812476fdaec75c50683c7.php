                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="small-box bg-info">
                            ...
                            <a href="<?php echo e(route('daftar')); ?>" class="small-box-footer"><small>Anda hanya boleh melakukan
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="small-box bg-success">
                            ...
                            <a href="<?php echo e(route('tanahindex')); ?>" class="small-box-footer"><small>Lengkapkan senarai geran
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="small-box bg-warning">
                            ...
                            <a href="<?php echo e(route('ptundaf')); ?>" class="small-box-footer"><small>Lengkapkan tuntutan bagi tanah
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="small-box bg-danger">
                            ...
                            <a href="<?php echo e(route('carian')); ?>" class="small-box-footer">Ketahui status semasa tuntutan <i
