...
<link rel="stylesheet" href="{{ asset('cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css') }}">
...
<div id="preloader" class="image preloader flex-column justify-content-center align-items-center">
    ...
    <svg class="animation__shake" viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" xmlns:bx="https://boxy-svg.com" alt="Logo" width="80" height="80">
