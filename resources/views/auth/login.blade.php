                    ...
                    <div class="card" style="background-color: gold; border-radius: 1rem;">
                        <div class="card-body">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <p class="mb-0">Untuk pengguna baru sila daftar dahulu <a href={{ url('register')}} class="btn btn-outline-light btn-lg px-5 btn-success" onclick="openNewPage()">Daftar</a></p>
                            </form>
