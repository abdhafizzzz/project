                        ...
                        <div class="col-md-6">
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    ...
                                    <a href="{{ route('daftar2') }}" class="btn btn-primary">Kemaskini Maklumat Pembayaran</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- jQuery -->
{{-- <script src="plugins/jquery/jquery.min.js"></script> , after commented this, logout dropout working here --}}
<!-- jQuery UI 1.11.4 -->
